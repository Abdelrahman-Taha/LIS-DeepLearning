...
The main script for generating Figure 12 as shown below, illustrated in the [published article](https://ieeexplore.ieee.org/document/9370097), is named `Fig12_generator.m`. 
